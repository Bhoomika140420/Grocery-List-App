...
function App() {
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      (async () => await fetchError())(); // it reload the page after 2 seconds
    }, 2000)(async () => await fetchItems())(); //fetchItems does not return a value, so created async fun to return items
  }, []);
